...
//   STRIP_PIN (GPIO26) -> strip DIN  (3.3V data, direct from the RP2040)
...
#define STRIP_PIN   26    // GP26 (carrier redesign; UART link moved to GP15 via PIO)
#define STRIP_LEDS  8
...
int main() {
    ...
    status_led_init();
    strip_init();          // external 8-LED status strip on the case (GPIO26)
