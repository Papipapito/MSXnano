...
echo                6b   CONFIG  .ROM
echo -----------------------------------------------------------------------------
copy /b a1xxjis1.rom + a1xxjis2.rom + Nextor-2.1.1.WonderTANG.ROM.bin + 32k_msx2p_int_fix.bin + 16k_msx2p_subrom.bin + ..\msxnano_menu\fm_logo_menu.bin + knmsxppl.rom + esp8266e.rom + logo16k.bin + 6b_config.bin goauld_rom_int.bin
copy /b a1xxjis1.rom + a1xxjis2.rom + Nextor-2.1.1.WonderTANG.ROM.bin + a1wsxyen.rom + 2pextrtc.rom + ..\msxnano_menu\fm_logo_menu.bin + knmsxppl.rom + esp8266e.rom + logo16k.bin + 6b_config.bin goauld_rom_japan.bin
